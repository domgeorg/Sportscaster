...
enum class TextType(
    ...
    TITLE_1(0, BaseColors.neutral100, SIZE_TITLE_1, LINE_HEIGHT_40, isBold = false),
    TITLE_2(1, BaseColors.neutral100, SIZE_TITLE_2, LINE_HEIGHT_26, isBold = false),
    TITLE_3(2, BaseColors.neutral100, SIZE_TITLE_3, LINE_HEIGHT_20, isBold = false),
    TITLE_4(3, BaseColors.neutral100, SIZE_TITLE_4, LINE_HEIGHT_18, isBold = false),
    ...
    TITLE_4_DESTRUCTIVE(7, BaseColors.red400, SIZE_TITLE_4, LINE_HEIGHT_18, isBold = false),

    TITLE_1_INFORMATIVE(8, BaseColors.neutral900, SIZE_TITLE_1, LINE_HEIGHT_40),
    TITLE_2_INFORMATIVE(9, BaseColors.neutral900, SIZE_TITLE_2, LINE_HEIGHT_26),
    TITLE_3_INFORMATIVE(10, BaseColors.neutral900, SIZE_TITLE_3, LINE_HEIGHT_20),
    TITLE_4_INFORMATIVE(11, BaseColors.neutral900, SIZE_TITLE_4, LINE_HEIGHT_18),

    BODY_1(12, BaseColors.neutral200, TEXT_SIZE_14, LINE_HEIGHT_20, isBold = false),
    BODY_1_HIGHLIGHT(13, BaseColors.neutral200, TEXT_SIZE_14, LINE_HEIGHT_20, isBold = false),

    BODY_2(14, BaseColors.neutral200, TEXT_SIZE_12, LINE_HEIGHT_18, isBold = false),
